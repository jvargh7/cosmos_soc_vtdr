...
--select * from ProjectD0C076.dbo.medications;
/*---------------------------------------------------------------------------------------------------------------------------------------------------------------*//*---------------------------------------------------------------------------------------------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------------------------------------------------------------------------------------------*//*---------------------------------------------------------------------------------------------------------------------------------------------------------------*/
...
Select count(*) from #Filter_cat1; -- There are 48 million+ rows
/* Plan is to split the dataset into 2 and save that to the Project database. Will need to union the 2 before running)*/
...
Select top 100 * from ProjectD0C076.dbo.filterCat1;
USE COSMOS;
...
Select count(*) from ProjectD0C076.dbo.filterCat1;
...
Select count(*) from  ProjectD3A05D.dbo.filterCat5a;encounterkey
