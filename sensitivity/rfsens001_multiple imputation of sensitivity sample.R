...
before_imputation = sensitivity_analytic %>% 
...
saveRDS(mi_dfs, paste0(path_retinopathy_fragmentation_folder,"/working/rfsens001_multiple imputation of sensitivity.RDS"))
